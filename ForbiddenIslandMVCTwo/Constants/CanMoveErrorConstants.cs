...
namespace ForbiddenIslandMVCTwo.Constants
{
    ...
    {
        public const string ONLY_MOVE_ONE_ROW = "Can not move from {0} to {1}. Can only move one row at a time";
        public const string ONLY_MOVE_ONE_COLUMN = "Can not move from {0} to {1}. Can only move one column at a time";
